...
class TestKauppa(unittest.TestCase):
    ...
    def test_tilisiirto_kutsutaan_oikeilla_parametreilla_kaksi(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_tilisiirto_kutsutaan_oikeilla_parametreilla_kolme(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_tilisiirto_kutsutaan_oikeilla_parametreilla_nelja(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_aloita_asiointi_nollaa(self):
        ...
        self.assertEqual(Tuote(1, "maito", 5) in kauppa._ostoskori._tuotteet, False)
